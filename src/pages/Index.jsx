...
const Index = () => {
  return (
    <Box maxW="container.xl" mx="auto" p={5} style={{ fontFamily: "'Times New Roman', Times, serif" }}>
      <Flex direction={{ base: 'column', md: 'row' }} align="center" justify="space-between" p={5}>
        <Heading as="h1" size="xl" style={{ filter: 'pixelate(3)' }}>John Doe</Heading>
        <HStack spacing={4}>
      ...
      <VStack spacing={8} mt={10}>
        <Box id="about" p={5}>
          <Heading as="h2" size="lg" style={{ filter: 'pixelate(3)' }}>About</Heading>
        ...
        <Box id="projects" p={5}>
          <Heading as="h2" size="lg" style={{ filter: 'pixelate(3)' }}>Projects</Heading>
        ...
        <Box id="skills" p={5}>
          <Heading as="h2" size="lg" style={{ filter: 'pixelate(3)' }}>Skills</Heading>
          <Text mt={3}>Proficient in: JavaScript, React, Node.js, Python. Familiar with: Docker, Kubernetes, AWS.</Text>
        </Box>
        <Box id="contact" p={5}>
          <Heading as="h2" size="lg" style={{ filter: 'pixelate(3)' }}>Contact</Heading>
          <VStack spacing={3}>
